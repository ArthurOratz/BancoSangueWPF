...
namespace Banco_de_Sangue
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<Doador> Doador = new List<Doador>();
            List<Funcionario> Funcionario = new List<Funcionario>();
            List<Hospital> Hospital = new List<Hospital>();
            List<Coleta_Sangue> Coleta_Sangue = new List<Coleta_Sangue>();
            List<Pedido_Sangue> Pedido_Sangue = new List<Pedido_Sangue>();
            List<Tipo_Sanguineo> Tipo_Sanguineo = new List<Tipo_Sanguineo>();
            List<Estoque_Sangue> Estoque_Sangue = new List<Estoque_Sangue>();
